package ru.mirea.mahmoud.b.i.networkstate;
    ...
    private void prepareReceiver(Context context){
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                NetworkInfo activityNetwork = cManager.getActiveNetworkInfo();
                if (activityNetwork != null){
                    boolean isConnected = activityNetwork.isConnectedOrConnecting();
